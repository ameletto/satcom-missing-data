...
#define ROCKBLOCK_RX_PIN MISSING_DATA  // Recieve data pin from Rockblock (seial data from RockBLOCK)
#define ROCKBLOCK_TX_PIN MISSING_DATA  // Transmit data pin to Rockblock (serial data to RockBLOCK)
